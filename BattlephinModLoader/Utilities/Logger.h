...
#define APP_NAME "BattlephinModLoader"
#define LOG_STREAM stdout

//Grabbed from UML, actually this is the same logger I have used for years, perhaps I need to write a new one, perchance.
...
public:
	...
	{
		FILE* Log = NULL;
		fopen_s(&Log, "BPLoader-Log.txt", "w+");
		if (Log)
		{
